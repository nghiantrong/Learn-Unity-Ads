...
public class AdsManager : MonoBehaviour
{
    ...
    #if UNITY_ANDROID
        private string _adBannerUnitId = "ca-app-pub-3842079496260306/7305323768";
    #elif UNITY_IPHONE
    ...
    // These ad units are configured to always serve test ads.
    #if UNITY_ANDROID
        private string _adInterstitialUnitId = "ca-app-pub-3842079496260306/8834027854";
#elif UNITY_IPHONE
    ...
    // These ad units are configured to always serve test ads.
    #if UNITY_ANDROID
        private string _adRewardedUnitId = "ca-app-pub-3842079496260306/2947276353";
    #elif UNITY_IPHONE
    ...
    public void ShowRewardedAd()
    {
        ...
        if (_rewardedAd != null && _rewardedAd.CanShowAd())
        {
            _rewardedAd.Show((Reward reward) =>
            {
                ...
                {
                    //Add rewaredAmount to the current integer value
                    currentValue += rewaredAmount;
